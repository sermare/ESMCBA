...
run_id = f'aug_{num_augmentations_input}_maskprob_{mask_prob_input}_lr_{lr_input}_LTU_{layers_to_unfreeze}_{hla_type}'

strategy = 'fine-tune'  

hla_type_folder = hla_type.replace("*", "-").replace(":", "")
...
model_dir = f'/global/scratch/users/sergiomar10/models/masking/{hla_type_folder}/{run_id}/'
loss_dir = f'/global/scratch/users/sergiomar10/losses/masking/{hla_type_folder}/{run_id}/'
