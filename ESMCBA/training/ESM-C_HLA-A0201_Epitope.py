...
print(f"Filtered {len(filtered_data)} unique sequences for training.", flush=True)
...
train_data, temp_data = train_test_split(filtered_data_new, test_size=0.2, random_state=42, shuffle=True)
